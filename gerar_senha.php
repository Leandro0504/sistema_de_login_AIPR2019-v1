        ...
        <section class="row justify-content-center">
            <div class="col-lg-5 mt-5">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="submit" value=":: Gerar nova senha ::" name="Criar" class="btn btn-success btn-block" style="font-weight:bolder; padding: 10px; font-size: 22px; box-shadow: 1px 1px 5px black;">
                    </div>
